...
class SubscriberController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      session()->flash('status','Please see confirmation code in your mail box and send it back!');
    ...
    public function confirmation(Request $request){
      ...
      if ($subscriber === null) {
        // echo "Fail";
        session()->flash('error','Try again!, Your code is wrong and please check in your mailbox');
        return redirect()->route('blog-posts.index');
         // user doesn't exist
      }
        ...
        Subscriber::where('id',"=", $id)->update(['scribe'=>1,'confirmation_code'=>'confirmed']);
        ...
        session()->flash('status',"Your Subscription has been finished!");
        return redirect()->route('blog-posts.index');
      }
