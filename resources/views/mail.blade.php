...
<html lang="en" dir="ltr">
  ...
  <p> A new post {{$title}} of {{$author}} has been updated from <strong>"ITVisionHub Feed Zone"</strong></p>

  <p> Click <a href="http://localhost:8000" target="_blank"> here </a> to read</p>

  <p>Sincerly,</p>
  <!-- EMAIL SIGNATURE STARTS HERE -->
  <span class="signature-name">ITVisionHub Feed Zone</span>
